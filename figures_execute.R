...
HA_plot("results/SEM missing x3", exclude.chars = "+07", z.plot.ind = 1:6, z.plot.ind.label = (1:7)[-3], conf.ind = 2:3, all.ind = 1:6,
...
HA_plot("results/block independent", z.plot.ind = c(1, 7, 9, 13, 14, 20, 22, 26), conf.ind = 1:13, all.ind = 1:26,
